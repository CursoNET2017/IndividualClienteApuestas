				...
				<div class="row">    
			        <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">		
						<div class="form-group">
							...
							<div class="col-xs-4">
						  		<input v-bind:disabled="editable" v-model="filtrada.Evento1" type="text" class="form-control" aria-label="Evento" v-bind:class="{claseError: !valido.b}">
                            ...
                            <div class="col-xs-4">
						  		<input v-bind:disabled="editable" v-model="filtrada.Evento2" type="text" class="form-control" aria-label="Evento" v-bind:class="{claseError: !valido.c}">
                ...
                <div class="row">    
			        <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">  
						<div class="form-group">
            				...
            				<div class="col-xs-9">
						  		<input v-bind:disabled="editable" v-model="filtrada.Pronostico" type="text" class="form-control" aria-label="Pronostico" v-bind:class="{claseError: !valido.e}">
				...
				<div class="row">    
			        <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">		
						<div class="form-group">
							...
							<div class="col-xs-9">
						  		<input v-bind:disabled="editable" v-model="filtrada.Cuota" type="text" class="form-control" aria-label="Cuota" v-bind:class="{claseError: !valido.f}">
                ...
                <div class="row">    
			        <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">  
						<div class="form-group">
            				...
            				<div class="col-xs-9">
						  		<input v-bind:disabled="editable" v-model="filtrada.AVencedor" type="text" class="form-control" aria-label="AVencedor" v-bind:class="{claseError: !valido.g}">
				...
				<div class="row">    
			        <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">		
						<div class="form-group">
							...
							<div class="col-xs-9">
						  		<input v-bind:disabled="editable" v-model="filtrada.AResultado" type="text" class="form-control" aria-label="AResultado" v-bind:class="{claseError: !valido.h}">
				...
				<div class="row">    
			        <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">		
						<div class="form-group">
							...
							<div class="col-xs-9">
						  		<input v-bind:disabled="editable" v-model="filtrada.Cantidad" type="text" class="form-control" aria-label="Cantidad" v-bind:class="{claseError: !valido.i}">
                ...
                <div class="row">    
			        <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">		
						<div class="form-group">
							...
							<div class="col-xs-9">
						  		<input v-bind:disabled="editable" v-model="filtrada.DNIUsuario" type="text" class="form-control" aria-label="DNIUsuario" v-bind:class="{claseError: !valido.j}">
